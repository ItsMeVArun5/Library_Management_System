public class MainLayer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Lucida Handwriting", 0, 56)); 
        jLabel1.setForeground(new java.awt.Color(0, 102, 102));
        jLabel1.setText("College Library");


        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Book Details.png")));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Issue Book.png"))); 

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Return Books.png"))); 
