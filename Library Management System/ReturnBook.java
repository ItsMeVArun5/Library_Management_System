...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {
        ...
        {
            connect();
            query="select * from issue where Student_Id='"+t1.getText()+"';";
            ...
            t3.setText(rs.getString("Book_Id"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        try
        {
            ...
            if(rs.next())
            {
                ...
                query="delete from issue where Student_Id='"+t1.getText()+"';";
                stmt.executeUpdate(query);
                query="update books set Available='YES' where Book_Id='"+t3.getText()+"';";
                stmt.executeUpdate(query);
                disconnect();
